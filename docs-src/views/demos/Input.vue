  ...
  <div class="demo">
    <div class="ui-test">
      ...
      <div class="grid col-5">
        ...
        <VueInput loading v-model="string" placeholder="Type a message"/>
        ...
        <VueInput class="flat" loading v-model="string" placeholder="Type a message"/>
      </div>
      ...
      <div class="grid col-5">
        ...
        <VueInput disabled loading v-model="string" placeholder="Type a message"/>
        ...
        <VueInput disabled class="flat" loading v-model="string" placeholder="Type a message"/>
      </div>
